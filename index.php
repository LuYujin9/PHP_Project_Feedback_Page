<?php include 'inc/header.php'; //require: when the file is not there, it will stop everything
?>

<?php
$name = $email = $body = ''; //short hand to set the values as empty strings.
...
<div class="container d-flex flex-column align-items-center">
  <h2>Feedback</h2>
  <p class="lead text-center">Leave feedback for my repositories in Github</p>
